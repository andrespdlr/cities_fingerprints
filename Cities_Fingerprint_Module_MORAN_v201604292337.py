...
for localidad in localidades_100k_dictionary.keys():
        ...
        input_layer = "C:\\Users\\Andres\\geo_mex_2015\\{}\\{}_manzanas_urbanas_joined.shp".format(edo, localidad)
        output_layer = "C:\\Users\\Andres\\geo_mex_2015\\{}\\{}_manzanas_urbanas_joined_moran.shp".format(edo, localidad)
        try:
                arcpy.ClustersOutliers_stats(input_layer, "PHI", output_layer, "INVERSE_DISTANCE", "EUCLIDEAN_DISTANCE", "NONE", "", "", "NO_FDR")
                print(localidad + " completed at ", datetime.datetime.now().isoformat())
        except:
                print(localidad + " EMPTY ", datetime.datetime.now().isoformat())
